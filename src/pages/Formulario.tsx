...
export function Formulario() {
  ...
  const inputClass = 'w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 focus:bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all duration-200';
  ...
  return (
    <main className="min-h-screen bg-[#F5F5DC] py-12 px-4 font-sans flex justify-center items-start md:items-center pt-[100px]">
      <div className="bg-white w-full max-w-3xl rounded-[24px] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden">
        ...
        <div className="bg-gray-50/50 p-8 pb-6 text-center border-b border-gray-100">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Estado */}
            <div>
              <label className="block text-[13px] font-bold text-gray-700 uppercase tracking-wide mb-2">Estado</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            <div className="relative">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-3 bg-gray-50 border ${cidadeValida ? 'border-orange-400 bg-orange-50/30' : 'border-gray-200'} rounded-xl text-gray-800 focus:bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all duration-200`}
              ...
              {mostrarDropdown && cidadeInput && !cidadeValida && cidadesFiltradas.length > 0 && (
                <ul className="absolute z-50 w-full bg-white border border-gray-200 rounded-xl shadow-lg mt-1 max-h-[200px] overflow-y-auto">
